...
export default {
  ...
  methods: {
    ...
    handleDataDictChange() {
      ...
      //urlGetData(this.modalFormData.urlData)
      //   .then((res) => {
      //    if (!res.data.code) {
      //     this.$message({
      //       message: "接口格式不正确",
  ...
  computed: {
    showLabel() {
      return typeof this.modalFormData.label !== "undefined";
    },
    showName() {
      return typeof this.modalFormData.name !== "undefined";
    },
    showRelation() {
      return typeof this.modalFormData.relation !== "undefined";
    },
    showPlaceholder() {
      return typeof this.modalFormData.placeholder !== "undefined";
    },
    showMaxLength() {
      return typeof this.modalFormData.maxLength !== "undefined";
    },
    showMaxSize() {
      return typeof this.modalFormData.maxSize !== "undefined";
    },
    showMarginTop() {
      return typeof this.modalFormData.marginTop !== "undefined";
    },
    showMarginBottom() {
      return typeof this.modalFormData.marginBottom !== "undefined";
    },
    showDetails_address() {
      return typeof this.modalFormData.details_address !== "undefined";
    },
    showRequire() {
      return typeof this.modalFormData.require !== "undefined";
    },
    showRuleError() {
      return typeof this.modalFormData.ruleError !== "undefined";
    },
    showFormat() {
      return typeof this.modalFormData.format !== "undefined";
    },
    showInlineBlock() {
      return typeof this.modalFormData.inlineBlock !== "undefined";
    },
    showMaxRows() {
